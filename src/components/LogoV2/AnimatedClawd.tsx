...
export function AnimatedClawd() {
  ...
  const _bodyColor = (_config as any).clawdBodyColor;
  const _eyeColor = (_config as any).clawdEyeColor;
  let t0;
  if ($[0] !== pose || $[8] !== _bodyColor || $[9] !== _eyeColor) {
    t0 = <Clawd pose={pose} bodyColor={_bodyColor} eyeColor={_eyeColor} />;
    $[0] = pose;
    $[8] = _bodyColor;
    $[9] = _eyeColor;
    $[1] = t0;
