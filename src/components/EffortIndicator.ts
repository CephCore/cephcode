import { EFFORT_HIGH, EFFORT_LOW, EFFORT_MAX, EFFORT_MEDIUM, EFFORT_XHIGH } from '../constants/figures.js';
import { type EffortLevel, type EffortValue, getDisplayedEffortLevel, modelSupportsEffort } from '../utils/effort.js';
 ...
 */
export function getEffortNotificationText(effortValue: EffortValue | undefined, model: string): string | undefined {
