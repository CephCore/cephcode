...
export function getBuiltinPlugins(): {
  ...
  for (const [name, definition] of BUILTIN_PLUGINS) {
    ...
    const plugin: LoadedPlugin = {
      ...
      enabled: isEnabled,
      isBuiltin: true,
      commandsPath: definition.commandsPath,
      commandsPaths: definition.commandsPaths,
      agentsPath: definition.agentsPath,
      agentsPaths: definition.agentsPaths,
      skillsPath: definition.skillsPath,
      skillsPaths: definition.skillsPaths,
      outputStylesPath: definition.outputStylesPath,
      outputStylesPaths: definition.outputStylesPaths,
