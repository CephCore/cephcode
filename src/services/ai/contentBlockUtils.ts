 ...
 */
export function fromOpenAIChatMessage(
  msg: { role: string; content: string | Array<{ type: string; text?: string; image_url?: { url: string } }> | null | undefined; tool_calls?: Array<{ id: string; function: { name: string; arguments: string } }>; tool_call_id?: string },
): ProviderContentBlock[] {
 ...
 */
export function fromGooglePart(
  part: Record<string, unknown>,
): ProviderContentBlock | null {
