...
const inputSchema = lazySchema(() =>
  z.strictObject({
    json: z
      .unknown()
      .describe('JSON data to process (object, array, or string)'),
    action: z
    ...
    query: z
      .string()
      .optional()
      .describe('JSONPath or key path to extract (e.g., "user.name", "items[0].id")'),
    indent: z
      .enum(['2', '4', 'tab'])
      .optional()
      .describe('Indentation for format action (default: 2)'),
    schema: z
      .unknown()
      .optional()
      .describe('JSON schema to validate against (for validate action)'),
    required: z
      .array(z.string())
      .optional()
      .describe('Required field names to check (for validate action)'),
  }),
)
...
const outputSchema = lazySchema(() =>
  z.object({
    ...
    result: z
      .unknown()
      .describe('Result of the operation (queried value, validation status, formatted string, etc.)'),
    error: z
      .string()
      .optional()
    ...
    matchCount: z
      .number()
      .optional()
      .describe('Number of matches found for query'),
    isValid: z
      .boolean()
      .optional()
    ...
    validationErrors: z
      .array(z.string())
      .optional()
      .describe('List of validation errors if invalid'),
  }),
)
