...
function createPermissionContext(
  ...
  const ctx = {
    ...
    async handleUserAllow(
      ...
      const userModified = tool.inputsEquivalent ? !tool.inputsEquivalent(input, updatedInput) : false;
...
export type { PermissionApprovalSource, PermissionContext, PermissionQueueOps, PermissionRejectionSource, ResolveOnce };
