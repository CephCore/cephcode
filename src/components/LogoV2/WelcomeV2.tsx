...
export function WelcomeV2(): React.ReactNode {
  ...
  if (isLightTheme) {
    ...
    // Horns row!
    const tHorn = <Text>{"      "}<Text color="clawd_body">  ▗   ▖  </Text>{"                                    "}</Text>;

    // Head top row
    const t12 = <Text>{"      "}<Text color="clawd_body"> █████████ </Text>{"                         ▒▒░░▒▒      ▒ ▒▒  "}</Text>;

    // Eye row - now with clawd_eye background!
    const t13 = <Text>{"      "}<Text color="clawd_body" backgroundColor="clawd_eye">██▄█████▄██</Text>{"                           ▒▒         ▒▒   "}</Text>;

    // Head bottom row
    const t14 = <Text>{"      "}<Text color="clawd_body"> █████████ </Text>{"                          ░          ▒     "}</Text>;
  ...
  const t14 = (
    <Text>
      {"      "}
      <Text color="clawd_body" backgroundColor="clawd_eye">██▄█████▄██</Text>
      <Text>{"                        "}</Text>
      <Text bold={true}>*</Text>
      <Text>{"                "}</Text>
    </Text>
  ...
  if (isLightTheme) {
    ...
    const t16 = (
      <Text>
        {"      "}
        <Text color="clawd_body">▗</Text>
        <Text color="clawd_eye" backgroundColor="clawd_body">{" "}▗{"     "}▖{" "}</Text>
        <Text color="clawd_body">▖</Text>
        {"                           ▒▒         ▒▒ "}
      </Text>
    );
